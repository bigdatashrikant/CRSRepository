...
public class MobileStoreProfileFormHandler extends StoreProfileFormHandler {
  ...
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/Mobile/src/atg/projects/store/mobile/userprofiling/MobileStoreProfileFormHandler.java#2 $$Change: 877954 $";
  ...
  protected void preCreateNewCreditCard(DynamoHttpServletRequest pRequest,
    ...
    Map ccMap = getMobileProfileTools().restoreCreditCardFromSession(false, getSessionBean());
    if (ccMap != null)
      getEditValue().putAll(ccMap);
