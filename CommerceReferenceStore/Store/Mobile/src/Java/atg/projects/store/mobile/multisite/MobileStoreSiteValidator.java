...
public class MobileStoreSiteValidator extends GenericService implements CollectionObjectValidator {
   ...
   */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/Mobile/src/atg/projects/store/mobile/multisite/MobileStoreSiteValidator.java#2 $$Change: 877954 $";
