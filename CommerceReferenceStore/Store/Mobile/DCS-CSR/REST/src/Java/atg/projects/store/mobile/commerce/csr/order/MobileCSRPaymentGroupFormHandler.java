...
public class MobileCSRPaymentGroupFormHandler extends CSRPaymentGroupFormHandler {
  ...
  //-------------------------------------
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/Mobile/DCS-CSR/REST/src/atg/projects/store/mobile/commerce/csr/order/MobileCSRPaymentGroupFormHandler.java#2 $$Change: 889821 $";
