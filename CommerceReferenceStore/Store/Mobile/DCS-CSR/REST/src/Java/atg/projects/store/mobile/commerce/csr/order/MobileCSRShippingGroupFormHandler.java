 ...
 *   with CRS which doesn't currently support in-store sale or multiple sgs on iOS apps
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Mobile/DCS-CSR/REST/src/atg/projects/store/mobile/commerce/csr/order/MobileCSRShippingGroupFormHandler.java#2 $$Change: 889821 $
...
public class MobileCSRShippingGroupFormHandler extends
  ...
  //-------------------------------------
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/Mobile/DCS-CSR/REST/src/atg/projects/store/mobile/commerce/csr/order/MobileCSRShippingGroupFormHandler.java#2 $$Change: 889821 $";
  ...
  /**
   * Returns the locationId used when moving items to an InStoreSaleShippingGroup
   * @return mLocationId
   */
  ...
  public void preApplyShippingGroups(DynamoHttpServletRequest pRequest,
    ...
    // if we're trying to move commerce items to an in-store sale shipping group,
