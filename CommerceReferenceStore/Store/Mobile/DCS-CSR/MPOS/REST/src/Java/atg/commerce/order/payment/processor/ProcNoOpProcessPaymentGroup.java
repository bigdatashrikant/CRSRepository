...
package atg.commerce.order.payment.processor;
...
/**
 * Implementation of ProcProcessPaymentGroup that does nothing and returns success for
 * authorize, debit, and credit
 *
 */
public class ProcNoOpProcessPaymentGroup extends ProcProcessPaymentGroup {
  ...
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/Mobile/DCS-CSR/MPOS/REST/src/atg/commerce/order/payment/processor/ProcNoOpProcessPaymentGroup.java#2 $$Change: 889821 $";

  @Override
  public PaymentStatus authorizePaymentGroup(PaymentManagerPipelineArgs pParams)
      throws CommerceException {
    return createSuccessStatus(pParams);
  }
  ...
  PaymentStatus createSuccessStatus(PaymentManagerPipelineArgs pParams) {
    return new PaymentStatusImpl(Long.toString(System.currentTimeMillis()), 
        pParams.getAmount(), true, "", new Date (System.currentTimeMillis ()));
  }
