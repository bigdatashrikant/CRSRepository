 ...
 *
 * @author Peter Eddy
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Mobile/DCS-CSR/src/atg/projects/store/returns/AgentStoreReturnTools.java#3 $Change: 630322 $
 * @updated $DateTime: 2014/05/19 07:34:51 $Author: ykostene $
 */

public class AgentStoreReturnTools extends StoreReturnTools
{
  public static final String
    CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/Mobile/DCS-CSR/src/atg/projects/store/returns/AgentStoreReturnTools.java#3 $Change: 630322 $";
