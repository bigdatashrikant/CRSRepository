 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/scenario/action/StoreFillRelatedItemsSlotActionConfiguration.java#2 $$Change: 877954 $ 
...
public class StoreFillRelatedItemsSlotActionConfiguration extends FillRelatedItemsSlotActionConfiguration {
   ...
   * Class version
   */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/scenario/action/StoreFillRelatedItemsSlotActionConfiguration.java#2 $$Change: 877954 $";
