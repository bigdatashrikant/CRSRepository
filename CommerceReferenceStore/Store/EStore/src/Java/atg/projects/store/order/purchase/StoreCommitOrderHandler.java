 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/purchase/StoreCommitOrderHandler.java#3 $$Change: 883241 $ 
...
public class StoreCommitOrderHandler extends CommitOrderFormHandler {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/purchase/StoreCommitOrderHandler.java#3 $$Change: 883241 $";
  ...
  public void preCommitOrder(DynamoHttpServletRequest pRequest, DynamoHttpServletResponse pResponse)
    ...
    // reprice order before commit to be sure that shipping prices and taxes are included
    try {
