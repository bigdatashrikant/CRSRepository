 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/droplet/ProfileSecurityStatus.java#2 $
 */
public class ProfileSecurityStatus extends DynamoServlet {
  
  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/droplet/ProfileSecurityStatus.java#2 $$Change: 877954 $";
