 ...
 * <dt>hreflang</dt><dd>Rendered only for links with rel="alternate". Contains the link langhref attribute.</dd> 
 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/droplet/DocumentLinksDroplet.java#2 $$Change: 877954 $
 * @updated $DateTime: 2014/03/25 06:51:13 $$Author: releng $
 */
public class DocumentLinksDroplet extends CanonicalItemLink {
  
  /** Class version string */
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/droplet/DocumentLinksDroplet.java#2 $$Change: 877954 $";

  // Input parameters
  public final static String CURRENT_CATEGORY = "currentCategory";
  public final static String CURRENT_PRODUCT = "currentProduct";
  public final static String CURRENT_SITE_ID = "currentSiteId";
  
  // Output parameters
  public final static String REL = "rel";
  public final static String HREF = "href";
  public final static String LANG = "lang";
  public final static String HREFLANG = "hreflang";
  
  public final static String ITEM = "item";
  public final static String LOCALE = "locale";
  public final static String PRODUCT_REPOSITORY_NAME = "/atg/commerce/catalog/ProductCatalog";
  ...
  public void service(DynamoHttpServletRequest pRequest,
     ...
     */    
    Map links = 
      getDocumentLinksService().getBreadcrumbsLinks(currentCategory, currentProduct, getCatalogNavHistory());
