 ...
 *  
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/droplet/StoreCurrencyFormatter.java#2 $$Change: 877954 $
...
public class StoreCurrencyFormatter extends CurrencyFormatter{
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/droplet/StoreCurrencyFormatter.java#2 $$Change: 877954 $";
  ...
  protected String formatCurrency(DynamoHttpServletRequest pRequest,
    ...
    // No custom format for the locale, call the super method.
