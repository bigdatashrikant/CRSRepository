 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/multisite/StoreSitePropertiesManager.java#2 $$Change: 877954 $
...
public class StoreSitePropertiesManager {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/multisite/StoreSitePropertiesManager.java#2 $$Change: 877954 $";
  ...
  //-------------------------------------
  // property: OrderReturnFromAddressPropertyName
  //-------------------------------------
  protected String mOrderReturnFromAddressPropertyName = "orderReturnFromAddress";

  /**
   * @return the String
   */
  public String getOrderReturnFromAddressPropertyName() {
    return mOrderReturnFromAddressPropertyName;
  }

  /**
   * @param pOrderReturnFromAddressPropertyName the String to set
   */
  public void setOrderReturnFromAddressPropertyName(String pOrderReturnFromAddressPropertyName) {
    mOrderReturnFromAddressPropertyName = pOrderReturnFromAddressPropertyName;
  }
