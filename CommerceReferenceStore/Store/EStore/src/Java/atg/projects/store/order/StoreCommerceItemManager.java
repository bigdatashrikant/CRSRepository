 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/StoreCommerceItemManager.java#3 $
 * @updated $DateTime: 2014/04/15 07:49:50 $$Author: jsiddaga $
 */
public class StoreCommerceItemManager extends CommerceItemManager {
  
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/StoreCommerceItemManager.java#3 $$Change: 883241 $";
