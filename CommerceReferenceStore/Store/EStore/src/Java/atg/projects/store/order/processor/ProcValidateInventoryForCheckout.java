 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/processor/ProcValidateInventoryForCheckout.java#2 $$Change: 877954 $
...
public class ProcValidateInventoryForCheckout extends ApplicationLoggingImpl implements PipelineProcessor {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/processor/ProcValidateInventoryForCheckout.java#2 $$Change: 877954 $";
    ...
    throws InvalidParameterException 
  {
    ...
    ResourceBundle bundle = LayeredResourceBundle.getBundle(USER_MSGS_RES_NAME, resourceLocale);
