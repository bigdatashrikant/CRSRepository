 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/processor/StoreProcLoadPriceInfoObjects.java#2 $$Change: 877954 $
...
public class StoreProcLoadPriceInfoObjects extends ProcLoadPriceInfoObjects {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/processor/StoreProcLoadPriceInfoObjects.java#2 $$Change: 877954 $";
  ...
  protected void loadItemPriceInfo(Order pOrder, 
    ...
    if (piRepItem == null) {
      if (DynamicBeans.getBeanInfo(pCi).hasProperty(getPriceInfoRepositoryItemName())) {
        DynamicBeans.setPropertyValue(pCi, getPriceInfoRepositoryItemName(), null);
      }
  ...
  protected void loadTaxPriceInfo(Order pOrder, 
    ...
    if (tpiRepItem == null) {
      ...
      if (DynamicBeans.getBeanInfo(pAmountInfo).hasProperty(getTaxPriceInfoRepositoryItemName())) {
        DynamicBeans.setPropertyValue(pAmountInfo, getTaxPriceInfoRepositoryItemName(), null);
      }
