 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/droplet/ComparisonRowExistsDroplet.java#2 $$Change: 877954 $
 * @updated $DateTime: 2014/03/25 06:51:13 $$Author: releng $
 */
public class ComparisonRowExistsDroplet extends ForEach {

  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/droplet/ComparisonRowExistsDroplet.java#2 $$Change: 877954 $";
