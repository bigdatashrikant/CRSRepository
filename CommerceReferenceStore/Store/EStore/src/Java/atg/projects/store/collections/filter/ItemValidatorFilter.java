 ...
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/collections/filter/ItemValidatorFilter.java#2 $Change: 630322 $
...
public class ItemValidatorFilter extends ValidatorFilter implements ItemFilter {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/collections/filter/ItemValidatorFilter.java#2 $Change: 630322 $";
  ...
  public Object[] filterItems(Object[] pItems, NameResolver pResolver) {
    ...
    try {
      Collection resultCollection = filterCollection(Arrays.asList(pItems), null, null);
