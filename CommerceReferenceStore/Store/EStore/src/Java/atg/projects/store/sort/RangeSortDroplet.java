 ...
 * Input Parameters:
 * 
 * <code>sortProperty</code> - This property should indicate which 
...
public class RangeSortDroplet extends Range{
  ...
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/sort/RangeSortDroplet.java#2 $$Change: 877954 $";
  ...
  /** 
   * @return A ServiceMap of sorter names e.g "price" and the components used 
   * to sort
   */
  ...
  /** 
   * @param pSorters A ServiceMap of sorter names e.g "price" and the components
   * used to sort
   */
