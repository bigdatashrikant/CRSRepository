 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/processor/ProcValidateGiftCardForCheckout.java#2 $$Change: 877954 $
...
public class ProcValidateGiftCardForCheckout extends ApplicationLoggingImpl implements PipelineProcessor {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/processor/ProcValidateGiftCardForCheckout.java#2 $$Change: 877954 $";
   ...
   * Resource bundle.
   */
  protected static final ResourceBundle sResourceBundle = LayeredResourceBundle.getBundle(RESOURCE_NAME,
      atg.service.dynamo.LangLicense.getLicensedDefault());

  /**
   * User resource bundle.
   */
  protected static final ResourceBundle sUserResourceBundle = 
