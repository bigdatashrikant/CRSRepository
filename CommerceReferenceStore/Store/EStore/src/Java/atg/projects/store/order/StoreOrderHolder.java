 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/StoreOrderHolder.java#2 $
 * @updated $DateTime: 2014/03/25 06:51:13 $$Author: releng $
 */
public class StoreOrderHolder extends OrderHolder {
  
  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/StoreOrderHolder.java#2 $$Change: 877954 $";
