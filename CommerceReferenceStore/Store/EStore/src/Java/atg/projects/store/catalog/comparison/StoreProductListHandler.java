 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/catalog/comparison/StoreProductListHandler.java#2 $
 * @updated $ $$ $
 */
public class StoreProductListHandler extends ProductListHandler
{
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/catalog/comparison/StoreProductListHandler.java#2 $$Change: 877954 $";
