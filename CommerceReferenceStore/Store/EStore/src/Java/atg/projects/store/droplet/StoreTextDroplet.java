 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/droplet/StoreTextDroplet.java#2 $$Change: 877954 $
...
public class StoreTextDroplet extends DynamoServlet {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/droplet/StoreTextDroplet.java#2 $$Change: 877954 $";
  ...
  public void service( DynamoHttpServletRequest pRequest,
    ...
    try {
       ...
       */
      if ( mode == Mode.BY_KEY ) {
        String messageTemplate = getMessageTemplateByKey( keyParamValue );
      ...
      if ( mode == Mode.BY_TAG ) {
        ...
        String[] messageTemplates = getMessageTemplatesByTag( tagParamValue );
