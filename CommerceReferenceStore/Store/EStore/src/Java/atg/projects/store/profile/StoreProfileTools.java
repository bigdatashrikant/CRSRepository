...
public class StoreProfileTools extends CommerceProfileTools {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/profile/StoreProfileTools.java#2 $$Change: 877954 $";
   ...
   * @throws RepositoryException indicates that a severe error occurred while performing a Repository task
   */
  public void updateEmailRecipient(RepositoryItem pProfile, String pEmail, 
    String pNewEmail, String pSourceCode) throws RepositoryException 
  {
    StorePropertyManager propertyManager = (StorePropertyManager) getPropertyManager();
    
    /*
     * If this user subscribes to receive promotional emails update the 
     * emailRecipient item in the repository to reference the new email address
    ...
    if (emailRecipient != null) {
      ...
      getProfileRepository().updateItem(emailRecipient);
    } 
  }
