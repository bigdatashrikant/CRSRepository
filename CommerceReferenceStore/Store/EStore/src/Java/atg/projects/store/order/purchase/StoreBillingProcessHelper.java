 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/purchase/StoreBillingProcessHelper.java#3 $$Change: 886143 $ 
 * @updated $DateTime: 2014/04/30 09:24:52 $$Author: jsiddaga $
 */
public class StoreBillingProcessHelper extends StorePurchaseProcessHelper {
  
  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/purchase/StoreBillingProcessHelper.java#3 $$Change: 886143 $";
 ...
 /**
  ...
  public void setupStoreCreditPaymentGroupsForOrder(Order pOrder, RepositoryItem pProfile, String[] pOnlineCreditIds)
    ...
    setupStoreCreditPaymentGroupsForOrder(pOrder, pProfile, pOnlineCreditIds, true);
  }
   ...
   * @param pProfile - the profile to which the order belongs.
   * @param pOnlineCreditIds - the online credit cards ids.
   * @param pAddOrderAmountRemaining - whether or not the order amount remaining should be added to a payment group
   *
   * @throws CommerceException if an error occurs
   * @throws RepositoryException if an error occurs
   * @throws IOException if an error occurs
   * @throws ServletException if an error occurs
   */
  public void setupStoreCreditPaymentGroupsForOrder(Order pOrder, RepositoryItem pProfile, String[] pOnlineCreditIds, boolean pAddOrderAmountRemaining)
    throws CommerceException, RepositoryException, IOException, ServletException{
