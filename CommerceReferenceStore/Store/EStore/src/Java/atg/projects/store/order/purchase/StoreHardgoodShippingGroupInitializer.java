 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/purchase/StoreHardgoodShippingGroupInitializer.java#2 $$Change: 877954 $
...
public class StoreHardgoodShippingGroupInitializer extends HardgoodShippingGroupInitializer {
  ...
  //-------------------------------------
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/order/purchase/StoreHardgoodShippingGroupInitializer.java#2 $$Change: 877954 $";
