 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/droplet/ColoredProductDetailsDroplet.java#3 $$Change: 883241 $
...
public class ColoredProductDetailsDroplet extends DefaultProductDetailsDroplet {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/src/atg/projects/store/droplet/ColoredProductDetailsDroplet.java#3 $$Change: 883241 $";
  ...
  protected static final String OPARAM_OUTPUT_ERROR = "error";
   ...
   */
  public static class Color { // Hide this class and display it to droplet's extensions only.
