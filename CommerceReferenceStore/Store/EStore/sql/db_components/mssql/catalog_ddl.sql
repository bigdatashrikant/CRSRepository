...
--  @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/sql/ddlgen/catalog_ddl.xml#1 $$Change: 875535 $
...
create index crs_catsite_ftrs1_x on crs_cat_site_features (category_id)
