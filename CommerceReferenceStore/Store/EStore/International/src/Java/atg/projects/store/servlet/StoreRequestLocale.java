 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/International/src/atg/projects/store/servlet/StoreRequestLocale.java#2 $
*/
public class StoreRequestLocale extends ProfileRequestLocale {

  /** Class version string */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/International/src/atg/projects/store/servlet/StoreRequestLocale.java#2 $$Change: 877954 $";
    ...
    RequestLocale pReqLocal) 
  {
    ...
    if(currentSiteContext != null) {
      ...
      if(site != null) {
        ...
        if(!StringUtils.isEmpty(storeDefaultLanguage) 
