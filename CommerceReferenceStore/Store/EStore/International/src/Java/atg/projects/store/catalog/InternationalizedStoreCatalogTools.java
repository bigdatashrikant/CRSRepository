 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/International/src/atg/projects/store/catalog/InternationalizedStoreCatalogTools.java#2 $$Change: 877954 $ 
...
public class InternationalizedStoreCatalogTools extends StoreCatalogTools
{
   ...
   * Class version
   */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/International/src/atg/projects/store/catalog/InternationalizedStoreCatalogTools.java#2 $$Change: 877954 $";
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/International/src/atg/projects/store/catalog/InternationalizedStoreCatalogTools.java#2 $$Change: 877954 $";
    ...
    public int compare(String pO1, String pO2)
    {
      ...
      if(order1 == null){
        throw new IllegalArgumentException("Cannot sort using null value for " + pO1);
      }
      
      if(order2 == null){
        throw new IllegalArgumentException("Cannot sort using null value for " + pO2);
      }
