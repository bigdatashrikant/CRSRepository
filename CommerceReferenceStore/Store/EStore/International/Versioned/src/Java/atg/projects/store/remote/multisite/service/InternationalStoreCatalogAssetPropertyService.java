 ...
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/International/Versioned/src/atg/projects/store/remote/multisite/service/InternationalStoreCatalogAssetPropertyService.java#2 $$Change: 889821 $
...
public class InternationalStoreCatalogAssetPropertyService extends RepositoryAssetPropertyServiceImpl{
  ...
  public static String CLASS_VERSION = 
    "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/EStore/International/Versioned/src/atg/projects/store/remote/multisite/service/InternationalStoreCatalogAssetPropertyService.java#2 $$Change: 889821 $";
        ...
        if (info == null || info.propertyValue == null || info.collectionDescriptorInfo == null) {
          if (isLoggingDebug()) {
            logDebug("Collection property " +  SITE_IDS + " does not have a cached value."); 
        	 ...
        	 if (info.propertyValue != null && info.propertyValue.size() > 0)
     			sites = super.getCollectionPropertyValues(pEditorInfo, SITE_IDS,
     			    info, 0, info.propertyValue.size());
