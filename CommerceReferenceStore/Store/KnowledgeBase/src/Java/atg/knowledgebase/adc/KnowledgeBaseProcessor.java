 ...
 * 
 * @version //hosting-blueprint/B2CBlueprint/main/KnowledgeBase/src/atg/knowledgebase/adc/KnowledgeBaseProcessor.java#5 $$Change: 877954 $
 * @updated gsasidha
 * 
 */
public class KnowledgeBaseProcessor extends AppendStringProcessor{
  ...
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/KnowledgeBase/src/atg/knowledgebase/adc/KnowledgeBaseProcessor.java#2 $$Change: 877954 $";
   ...
   */
  String ADD_COMPONENT = "dojo.ready(function(){" + newLine + "if (window.RightNow !== undefined && document.getElementById('atg_store_rightnowKnowledgebaseContainer') != null){" + newLine + " RightNow.Client.Controller.addComponent( {";
