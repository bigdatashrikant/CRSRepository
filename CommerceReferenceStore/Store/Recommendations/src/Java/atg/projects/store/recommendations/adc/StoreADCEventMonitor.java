 ...
 *   
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Recommendations/src/atg/projects/store/recommendations/adc/StoreADCEventMonitor.java#2 $Change: 630322 $
 * @updated $DateTime: 2014/03/25 06:51:13 $Author: ykostene $
 *
 */
public class StoreADCEventMonitor extends ADCEventMonitor {
  /** Class version string */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/Recommendations/src/atg/projects/store/recommendations/adc/StoreADCEventMonitor.java#2 $Change: 630322 $";
