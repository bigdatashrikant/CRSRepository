 ...
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Recommendations/src/atg/projects/store/recommendations/processor/SetSearchTermProcessor.java#2 $Change: 630322 $
 * @updated $DateTime: 2014/03/25 06:51:13 $Author: ykostene $
 *
 */
public class SetSearchTermProcessor extends PatternMappingProcessor{
  /** Class version string */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/Recommendations/src/atg/projects/store/recommendations/processor/SetSearchTermProcessor.java#2 $Change: 630322 $";
   ...
   */
  private AbstractCache mSearchResultsPagesCache;    
   ...
   */
  public AbstractCache getSearchResultsPagesCache() {
   ...
   */
  public void setSearchResultsPagesCache(AbstractCache pSearchResultsPagesCache) {
  ...
  public boolean pathMatchesPattern(String pPath, PagePattern[] pPatterns,
      AbstractCache pCache) throws Exception {
    if (pPatterns == null)
      return false;
    ...
    if (pCache != null)
      pCache.put(pPath, Boolean.valueOf(found));
    return found;
