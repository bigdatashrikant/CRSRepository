...
%>
		...
		<div dojoType="dijit.layout.ContentPane" title='<%=ics.GetVar("tabMarketing")%>' style="height: 100%; display:none;">
        <table class="width70BottomExMargin" border="0" cellpadding="0" cellspacing="0">
  <tr>
      <ics:if condition='<%=!(ics.GetVar("updatetype")!=null && ics.GetVar("updatetype").equals("setformdefaults"))%>'>
      <ics:then>
...
<%
  ...
  if (ics.GetVar("enablePreviewProperties") != null && ics.GetVar("enablePreviewProperties").equals("true"))
  {
%>
