 ...
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Endeca/Assembler/src/atg/projects/store/assembler/cartridge/handler/ActorInvokingCartridgeHandler.java#2 $$Change: 877954 $
...
public class ActorInvokingCartridgeHandler extends NavigationCartridgeHandler<ContentItem, ContentItem> {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/Endeca/Assembler/src/atg/projects/store/assembler/cartridge/handler/ActorInvokingCartridgeHandler.java#2 $$Change: 877954 $";
  ...
  public ContentItem process(ContentItem pCartridgeConfig) 
  {
    ...
    if(getActorExecutor()!=null){
      getActorExecutor().invokeActor(getActorToInvoke(), pCartridgeConfig);
    }   
