 ...
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Endeca/Assembler/src/atg/projects/store/assembler/cartridge/handler/FilteringRecordSpotlightHandler.java#3 $$Change: 885024 $
...
public class FilteringRecordSpotlightHandler extends RecordSpotlightHandler {
  ...
  public static final String CLASS_VERSION = 
    "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/Endeca/Assembler/src/atg/projects/store/assembler/cartridge/handler/FilteringRecordSpotlightHandler.java#3 $$Change: 885024 $";
  ...
  //-------------------------------------------------------
  // property: recordFilterBuilders
  //-------------------------------------------------------
  private RecordFilterBuilder[] mRecordFilterBuilders = null;

  /**
   * @return an array of RecordFilterBuilders.
   */
  ...
  /**
   * @param pRecordFilterBuilders - An array of RecordFilterBuilders.
   *          -
   */
  ...
  public void preprocess(RecordSpotlightConfig pCartridgeConfig) throws CartridgeHandlerException {
    ...
    if (filterState != null) {
      ...
      List<String> recordFilters =
          getStoreCartridgeTools().updateRecordFilters(filterState.getRecordFilters(), getRecordFilterBuilders());
