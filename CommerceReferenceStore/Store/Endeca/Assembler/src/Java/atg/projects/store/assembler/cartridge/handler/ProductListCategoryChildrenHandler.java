 ...
 * 
 * @author Paul Watson
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Endeca/Assembler/src/atg/projects/store/assembler/cartridge/handler/ProductListCategoryChildrenHandler.java#2 $$Change: 877954 $
...
public class ProductListCategoryChildrenHandler 
  ...
  public static final String CLASS_VERSION =
    "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/Endeca/Assembler/src/atg/projects/store/assembler/cartridge/handler/ProductListCategoryChildrenHandler.java#2 $$Change: 877954 $";
    ...
    try {  
      if (!StringUtils.isEmpty(chosenCategoryId)) {
        ...
        if (navigationFilters != null && navigationFilters.size() > 0) {
          ...
          pCartridge.setCategoryDimensionId(Long.parseLong(navigationFilters.get(0)));
        }
        else {
