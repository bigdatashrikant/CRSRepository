 ...
 *       
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Endeca/Assembler/src/atg/projects/store/droplet/DisplayLanguagesDroplet.java#2 $$Change: 889821 $
...
public class DisplayLanguagesDroplet extends DynamoServlet {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.1/Endeca/Assembler/src/atg/projects/store/droplet/DisplayLanguagesDroplet.java#2 $$Change: 889821 $";
  ...
  public String createLinkURL(Locale pLocale, DynamoHttpServletRequest pRequest) {
    ...
    if(!linkHome){
      Enumeration queryParameterNames = pRequest.getQueryParameterNames();
